...
######################################################
plot1 <- ggplot(df_filtered, aes(x = Global_active_power)) +
  geom_histogram(fill = "orange") +  # Cambiar el color de las barras a naranja
  labs(x = "Global Active Power (kilowatts)", y = "Frequency") +
  ggtitle("Global Active Power") +
  theme_minimal()+  theme(panel.grid.major = element_blank(),  
                          panel.grid.minor = element_blank())+  
  geom_histogram(fill = "orange", color = "black", aes(y = ..count..))

plot1
########################################################

# Paso 1: Combinar la fecha y la hora en una sola columna
...
# Paso 2: Graficar los tres sub-medidores en función del tiempo
...
ggsave( "combined_plot.png", width = 5, height = 5, limitsize = FALSE, bg = "transparent")
ggsave( "plot1.png", width = 5, height = 5, limitsize = FALSE, bg = "transparent")
ggsave( "plot2.png", width = 5, height = 5, limitsize = FALSE, bg = "transparent")
ggsave( "plot3.png", width = 5, height = 5, limitsize = FALSE, bg = "transparent")
ggsave( "plot4.png", width = 5, height = 5, limitsize = FALSE, bg = "transparent")
ggsave( "plot5.png", width = 5, height = 5, limitsize = FALSE, bg = "transparent")
